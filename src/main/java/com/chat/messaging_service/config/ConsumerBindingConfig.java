...
public class ConsumerBindingConfig {
    ...
    private Mono<ChatUser> handleError(Throwable e) {
        ...
        return Mono.just(new ChatUser()); //TODO: this is for handle the error, but this approach must be changed later
    }

    private UserRegistrationEvent decodeUserRegistrationEvent(String base64String) throws IOException {
